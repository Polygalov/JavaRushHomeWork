...
public class Shortener
{
    ...
    private StorageStrategy storageStrategy; //cтратегия хранения данных
    ...
    public synchronized Long getId(String string){ // возвращать идентификатор id для заданной строки
    ...
    public synchronized String getString(Long id){ //возвращать строку для заданного идентификатора или null
